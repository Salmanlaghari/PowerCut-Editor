...
object TransitionCatalog {
    ...
    private val SPECS: List<Spec> = listOf(
        ...
        // ── v7.3.1 — EXTENDED UI transition mappings (all map to real xfade) ──
        // Re-added after the user-side merge reset (commit acc1767 reset the
        // catalog). The editor UI (NextGenEditorScreen.kt TransitionsPanel)
        // exposes 56 additional transition ids; every one MUST resolve here
        // or the FFmpeg validation CI step fails with "UI transitions are
        // not mapped".
        Spec("wipeleft", "wipeleft"),
        Spec("wiperight", "wiperight"),
        Spec("wipeup", "wipeup"),
        Spec("wipedown", "wipedown"),
        Spec("slideleft", "slideleft"),
        Spec("slideright", "slideright"),
        Spec("slideup", "slideup"),
        Spec("slidedown", "slidedown"),
        Spec("circlecrop", "circlecrop"),
        Spec("rectcrop", "rectcrop"),
        Spec("distance", "distance"),
        Spec("fadeblack", "fadeblack"),
        Spec("fadewhite", "fadewhite"),
        Spec("radial", "radial"),
        Spec("smoothleft", "smoothleft"),
        Spec("smoothright", "smoothright"),
        Spec("smoothup", "smoothup"),
        Spec("smoothdown", "smoothdown"),
        Spec("circleopen", "circleopen"),
        Spec("circleclose", "circleclose"),
        Spec("vertopen", "vertopen"),
        Spec("vertclose", "vertclose"),
        Spec("horzopen", "horzopen"),
        Spec("horzclose", "horzclose"),
        Spec("pixelize", "pixelize"),
        Spec("diagtl", "diagtl"),
        Spec("diagtr", "diagtr"),
        Spec("diagbl", "diagbl"),
        Spec("diagbr", "diagbr"),
        Spec("hlslice", "hlslice"),
        Spec("hrslice", "hrslice"),
        Spec("vuslice", "vuslice"),
        Spec("vdslice", "vdslice"),
        Spec("hblur", "hblur"),
        Spec("fadegrays", "fadegrays"),
        Spec("wipetl", "wipetl"),
        Spec("wipetr", "wipetr"),
        Spec("wipebl", "wipebl"),
        Spec("wipebr", "wipebr"),
        Spec("squeezeh", "squeezeh"),
        Spec("squeezev", "squeezev"),
        // FFmpeg 7.1+ only names — bundled ffmpeg-kit 8.1.2 supports them
        Spec("zoomin", "zoomin", approximated = true, note = "zoomin xfade requires FFmpeg 7.1+; bundled ffmpeg-kit 8.1.2 supports it"),
        Spec("fadefast", "fadefast", approximated = true, note = "fadefast xfade requires FFmpeg 7.1+"),
        Spec("fadeslow", "fadeslow", approximated = true, note = "fadeslow xfade requires FFmpeg 7.1+"),
        Spec("hlwind", "hlwind", approximated = true, note = "hlwind xfade requires FFmpeg 7.1+"),
        Spec("hrwind", "hrwind", approximated = true, note = "hrwind xfade requires FFmpeg 7.1+"),
        Spec("vuwind", "vuwind", approximated = true, note = "vuwind xfade requires FFmpeg 7.1+"),
        Spec("vdwind", "vdwind", approximated = true, note = "vdwind xfade requires FFmpeg 7.1+"),
        Spec("coverleft", "coverleft", approximated = true, note = "cover* xfade requires FFmpeg 7.1+"),
        Spec("coverright", "coverright", approximated = true, note = "cover* xfade requires FFmpeg 7.1+"),
        Spec("coverup", "coverup", approximated = true, note = "cover* xfade requires FFmpeg 7.1+"),
        Spec("coverdown", "coverdown", approximated = true, note = "cover* xfade requires FFmpeg 7.1+"),
        Spec("revealleft", "revealleft", approximated = true, note = "reveal* xfade requires FFmpeg 7.1+"),
        Spec("revealright", "revealright", approximated = true, note = "reveal* xfade requires FFmpeg 7.1+"),
        Spec("revealup", "revealup", approximated = true, note = "reveal* xfade requires FFmpeg 7.1+"),
        Spec("revealdown", "revealdown", approximated = true, note = "reveal* xfade requires FFmpeg 7.1+")
    )
