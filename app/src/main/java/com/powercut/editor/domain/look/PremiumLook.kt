...
object PremiumLooks {
    ...
    val all: List<PremiumLook> = listOf(
        ...
        PremiumLook("hdr_cinema", "HDR Cinema", "hdr", "🎬",
            "Cinematic HDR with tonemap", "eq=contrast=1.22:saturation=1.18,unsharp=5:5:1.2:5:5:0,curves=preset=strong_contrast"),
        ...
        PremiumLook("hdr_pop", "HDR Pop", "hdr", "💥",
            "Punchy HDR with deep blacks", "eq=contrast=1.28:saturation=1.25,unsharp=5:5:1.4:5:5:0,curves=preset=strong_contrast"),
        ...
        PremiumLook("hdr_tonemap", "Tone-Mapped", "hdr", "🎚️",
            "Tone-mapped HDR roll-off", "eq=contrast=1.2:saturation=1.15,curves=preset=strong_contrast,unsharp=5:5:1.1:5:5:0"),
        ...
        PremiumLook("hdr_pro", "HDR Pro", "hdr", "🏆",
            "Pro HDR: contrast + sat + sharp + tone", "eq=contrast=1.26:saturation=1.22,unsharp=6:6:1.3:6:6:0,curves=preset=strong_contrast"),
        ...
        PremiumLook("iphone_rich", "iPhone Rich Contrast", "iphone", "🖤",
            "iPhone Rich Contrast style", "eq=contrast=1.18:saturation=1.1,unsharp=3:3:0.6:3:3:0,curves=preset=strong_contrast"),
        ...
        PremiumLook("iphone_cinematic", "iPhone Cinematic", "iphone", "🎥",
            "iPhone Cinematic mode depth look", "eq=contrast=1.15:saturation=1.05,curves=preset=strong_contrast,colorbalance=rs=0.03:bs=0.04"),
        ...
        PremiumLook("iphone_dolby", "iPhone Dolby Vision", "iphone", "🌗",
            "Dolby Vision HDR tone roll-off", "eq=contrast=1.2:saturation=1.18,curves=preset=strong_contrast,unsharp=5:5:1.0:5:5:0"),
        ...
        PremiumLook("iphone_contour", "iPhone Contour Light", "iphone", "⛰️",
            "Portrait Contour Light", "eq=contrast=1.15:saturation=1.05,curves=preset=strong_contrast,unsharp=4:4:0.6:4:4:0"),
        PremiumLook("iphone_stage", "iPhone Stage Mono", "iphone", "⚫",
            "Portrait Stage Mono", "eq=contrast=1.2:saturation=0,curves=preset=strong_contrast"),
        ...
        PremiumLook("cinema_noir", "Cinema Noir", "cinema", "🕶️",
            "High-contrast B&W noir", "eq=contrast=1.35:saturation=0,curves=preset=strong_contrast,unsharp=5:5:0.8:5:5:0"),
        ...
        PremiumLook("cinema_moody", "Moody Drama", "cinema", "🌧️",
            "Moody desaturated drama", "eq=contrast=1.2:saturation=0.82,curves=preset=strong_contrast"),
        ...
        PremiumLook("magic_auto", "Magic Auto", "magic", "🪄",
            "One-tap balanced auto grade", "eq=contrast=1.12:saturation=1.12,unsharp=4:4:0.7:4:4:0,curves=preset=strong_contrast"),
        ...
        PremiumLook("magic_bw", "Magic B&W", "magic", "⚪",
            "Auto monochrome + contrast", "eq=saturation=0:contrast=1.25,curves=preset=strong_contrast,unsharp=5:5:0.8:5:5:0"),
