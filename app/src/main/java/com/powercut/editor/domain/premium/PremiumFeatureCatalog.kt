...
object PremiumFeatureCatalog {
    ...
    val aiFeatures: List<PremiumFeature> = listOf(
        ...
        PremiumFeature("ai_object_remove", "AI Object Removal", "🪄", "AI Features", "Remove unwanted objects", "delogo=x=1:y=1:w=64:h=64", isPro = true),
        ...
        PremiumFeature("ai_remove_watermark", "AI Remove Watermark", "🚫", "AI Features", "Remove logo/watermark from video", "delogo=x=10:y=10:w=120:h=40", isPro = true),
