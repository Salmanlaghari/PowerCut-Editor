...
object PremiumFeatureCatalog {
    ...
    val basicEditing: List<PremiumFeature> = listOf(
        ...
        PremiumFeature("be_ai_video_gen", "Smart Video Generator", "🤖", "Basic Editing", "Generate video from text prompt", isPro = true),
        ...
        PremiumFeature("be_hdr", "HDR Export", "🌈", "Basic Editing", "10-bit HDR (BT.2020 PQ) export", "zscale=tin=bt709:min=709:pin=709:rin=tv:t=smpte2084:m=2020_ncl:p=2020:r=tv:npl=100,format=yuv420p10le"),
    ...
    val aiFeatures: List<PremiumFeature> = listOf(
        PremiumFeature("ai_auto_cut", "AI Auto Cut", "✂️", "Smart Features", "Smart scene-based auto cutting", "select='gt(scene,0.03)'", alreadyImplemented = true),
        PremiumFeature("ai_script_writer", "AI Script Writer", "✍️", "Smart Features", "Generate video scripts from a topic", isPro = true),
        PremiumFeature("ai_story_gen", "AI Story / Video Generator", "📖", "Smart Features", "Generate storyboards & video", isPro = true),
        PremiumFeature("ai_avatar", "AI Avatar / Presenter", "🧑‍💼", "Smart Features", "Animated AI presenter avatar", isPro = true),
        PremiumFeature("ai_character", "AI Character", "🧙", "Smart Features", "Custom AI character generation", isPro = true),
        PremiumFeature("ai_talking_photo", "AI Talking Photo", "🗣️", "Smart Features", "Animate a still photo to talk", isPro = true),
        PremiumFeature("ai_voice_gen", "Smart Voice Generator", "🎤", "Smart Features", "Text-to-speech voice generation", isPro = true),
        PremiumFeature("ai_voice_clone", "Smart Voice Clone", "🎭", "Smart Features", "Clone a voice from sample", isPro = true),
        PremiumFeature("ai_voice_changer", "Smart Voice Changer", "🔀", "Smart Features", "Change voice pitch & tone", "", "asetrate=44100*1.5,aresample=44100,atempo=0.8", alreadyImplemented = true),
        PremiumFeature("ai_noise_removal", "AI Noise Removal", "🔇", "Smart Features", "Remove background noise from audio", "", "afftdn=nr=20:nf=-25", alreadyImplemented = true),
        PremiumFeature("ai_music_gen", "AI Music Generator", "🎵", "Smart Features", "Generate royalty-free music", isPro = true),
        PremiumFeature("ai_beat_detect", "AI Beat Detection", "🥁", "Smart Features", "Detect beats for sync editing", alreadyImplemented = true),
        PremiumFeature("ai_captions", "AI Auto Captions", "💬", "Smart Features", "Auto-generate subtitles", alreadyImplemented = true),
        PremiumFeature("ai_subtitle_gen", "AI Subtitle Generation", "📑", "Smart Features", "Generate subtitles in multiple languages", alreadyImplemented = true),
        PremiumFeature("ai_translate", "AI Translation", "🌍", "Smart Features", "Translate captions across languages", isPro = true),
        PremiumFeature("ai_lip_sync", "AI Lip Sync", "👄", "Smart Features", "Sync audio to lip movement", isPro = true),
        PremiumFeature("ai_face_retouch", "AI Face Retouch", "✨", "Smart Features", "Smooth & retouch faces", "hqdn3d=2:1:2:1,eq=brightness=0.03:contrast=1.02", alreadyImplemented = true),
        PremiumFeature("ai_enhance", "AI Enhance / Portrait", "🖼️", "Smart Features", "Portrait enhancement & sharpening", "unsharp=5:5:0.8:3:3:0.4", alreadyImplemented = true),
        PremiumFeature("ai_upscale", "AI Upscale", "🔍", "Smart Features", "Upscale video resolution 2x", "scale=iw*2:ih*2:flags=lanczos,unsharp=5:5:0.6", isPro = true),
        PremiumFeature("ai_restore", "AI Restore", "🛠️", "Smart Features", "Restore old/damaged video", "hqdn3d=4:3:4:3,eq=contrast=1.1:saturation=1.1,unsharp=5:5:0.5", isPro = true),
        PremiumFeature("ai_image_enhance", "AI Image Enhance", "🌟", "Smart Features", "Enhance image quality", "unsharp=7:7:1.0:7:7:0.0,eq=brightness=0.04", isPro = true),
        PremiumFeature("ai_color_correct", "AI Color Correction", "🎨", "Smart Features", "Automatic color correction", "eq=contrast=1.1:saturation=1.15:brightness=0.02,curves=preset=strong_contrast", alreadyImplemented = true),
        PremiumFeature("ai_color_match", "AI Color Match", "🎯", "Smart Features", "Match colors between clips", "curves=preset=medium_contrast,eq=contrast=1.05:saturation=1.05", alreadyImplemented = true),
        ...
        PremiumFeature("ai_object_remove", "AI Object Removal", "🪄", "Smart Features", "Remove unwanted objects", "delogo=x=1:y=1:w=64:h=64", isPro = true),
        PremiumFeature("ai_bg_remove", "Smart Background Removal", "🧹", "Smart Features", "Remove/replace video background", "chromakey=0x00FF00:0.3:0.1", alreadyImplemented = true),
        PremiumFeature("ai_sky_replace", "AI Sky Replacement", "🌅", "Smart Features", "Replace sky in video", isPro = true),
        PremiumFeature("ai_relight", "AI Relight", "💡", "Smart Features", "Relight scenes after capture", "eq=brightness=0.08:contrast=1.05,curves=preset=lighter", isPro = true),
        PremiumFeature("ai_motion_track", "AI Motion Tracking", "🎯", "Smart Features", "Track motion of objects", isPro = true),
        PremiumFeature("ai_camera_track", "AI Camera Tracking", "📷", "Smart Features", "Track camera movement", isPro = true),
        PremiumFeature("ai_smart_cutout", "AI Smart Cutout / Mask", "✂️", "Smart Features", "Auto cutout subject & mask", alreadyImplemented = true),
        PremiumFeature("ai_auto_reframe", "Auto Reframe", "📐", "Smart Features", "Auto reframe for aspect ratios", "crop=iw*0.56:ih:(iw-iw*0.56)/2:0,scale=1080:1920", alreadyImplemented = true),
        PremiumFeature("ai_frame_interp", "AI Frame Interpolation", "🎞️", "Smart Features", "Interpolate frames for smoothness", "minterpolate=fps=60:mi_mode=mci:mc_mode=aobmc:me_mode=bidir", isPro = true),
        PremiumFeature("ai_slow_motion", "Smart Slow Motion", "🐌", "Smart Features", "Optical-flow slow motion", "minterpolate=fps=120:mi_mode=mci,setpts=4*PTS,fps=30", isPro = true),
        PremiumFeature("ai_super_res", "AI Super Resolution", "🔬", "Smart Features", "AI super-resolution upscale", "scale=iw*2:ih*2:flags=lanczos,unsharp=7:7:1.2:7:7:0", isPro = true),
        PremiumFeature("ai_denoise", "AI Video Denoise", "🧽", "Smart Features", "Reduce video grain & noise", "hqdn3d=4:3:4:3", alreadyImplemented = true),
        PremiumFeature("ai_deblur", "AI Deblur", "🌫️", "Smart Features", "Sharpen blurred footage", "unsharp=7:7:1.5:7:7:0.0", isPro = true),
        PremiumFeature("ai_deflicker", "AI Remove Flicker", "⚡", "Smart Features", "Remove frame flicker", "deflicker=mode=am:size=10", isPro = true),
        PremiumFeature("ai_remove_watermark", "AI Remove Watermark", "🚫", "Smart Features", "Remove logo/watermark from video", "delogo=x=10:y=10:w=120:h=40", isPro = true),
        PremiumFeature("ai_sticker_gen", "AI Sticker Generator", "😀", "Smart Features", "Generate custom stickers", isPro = true),
        PremiumFeature("ai_emoji_gen", "AI Emoji Generator", "😎", "Smart Features", "Generate custom emojis", isPro = true),
        PremiumFeature("ai_thumbnail_gen", "AI Thumbnail Generator", "🖼️", "Smart Features", "Generate video thumbnails", alreadyImplemented = true),
        PremiumFeature("ai_scene_detect", "AI Scene Detection", "🎬", "Smart Features", "Detect & mark scenes", "select='gt(scene,0.04)',showinfo", isPro = true),
        PremiumFeature("ai_highlight", "AI Highlight Detection", "⭐", "Smart Features", "Find highlight moments", isPro = true),
        PremiumFeature("ai_clip_select", "AI Clip Selection", "🎯", "Smart Features", "Auto-select best clips", isPro = true),
        PremiumFeature("ai_auto_zoom", "AI Auto Zoom", "🔍", "Smart Features", "Auto zoom to subject", "zoompan=z='min(zoom+0.0015,1.5)':d=1:s=1920x1080:fps=30", isPro = true),
        PremiumFeature("ai_auto_effects", "AI Auto Effects", "✨", "Smart Features", "Auto-apply effects to clips", alreadyImplemented = true),
        PremiumFeature("ai_auto_transition", "AI Auto Transition", "🔄", "Smart Features", "Auto-apply transitions", alreadyImplemented = true),
        PremiumFeature("ai_sound_effects", "AI Sound Effects", "🔊", "Smart Features", "Auto-generate sound effects", "", "aecho=0.6:0.3:100:0.3", isPro = true),
        PremiumFeature("ai_text_rewrite", "AI Text Rewrite", "📝", "Smart Features", "Rewrite & improve text", isPro = true),
        PremiumFeature("ai_prompt_video", "AI Prompt to Video", "🎥", "Smart Features", "Generate video from prompt", isPro = true),
        PremiumFeature("ai_prompt_image", "AI Prompt to Image", "🖼️", "Smart Features", "Generate image from prompt", isPro = true),
        PremiumFeature("ai_product_video", "AI Product Video", "🛍️", "Smart Features", "Create product showcase videos", isPro = true),
        PremiumFeature("ai_social_video", "AI Social Media Video", "📱", "Smart Features", "Generate social-optimized videos", isPro = true),
        PremiumFeature("ai_shorts", "AI Shorts / Reel Generator", "📲", "Smart Features", "Generate vertical short-form videos", "crop=iw*0.56:ih:(iw-iw*0.56)/2:0,scale=1080:1920", isPro = true),
        PremiumFeature("ai_tiktok", "AI TikTok Generator", "🎵", "Smart Features", "Generate TikTok-ready content", "crop=iw*0.56:ih:(iw-iw*0.56)/2:0,scale=1080:1920", isPro = true),
        PremiumFeature("ai_youtube", "AI YouTube Generator", "▶️", "Smart Features", "Generate YouTube-ready content", "scale=1920:1080", isPro = true),
        // v7.3 audit: Smart Hub tools that previously had no catalog entry (or an
        // empty chain) — selecting them did NOTHING at export. Every one now
        // maps to a real FFmpeg chain so the toggle always renders.
        PremiumFeature("ai_smart_crop", "AI Smart Crop", "🤖", "Smart Features", "Auto crop to subject", "crop=iw*0.8:ih*0.8:(iw-iw*0.8)/2:(ih-ih*0.8)/2,scale=iw*1.25:ih*1.25", isPro = true),
        PremiumFeature("ai_bg_blur", "AI BG Blur", "🌫️", "Smart Features", "Blur the video background", "boxblur=luma_radius=20:luma_power=2,eq=brightness=0.02", isPro = true),
        PremiumFeature("ai_style_transfer", "AI Style Transfer", "🎨", "Smart Features", "Artistic style filter", "edgedetect=low=0.08:high=0.3,format=gray,eq=contrast=1.35", isPro = true),
        PremiumFeature("ai_glamour", "Smart Glamour", "💄", "Smart Features", "Soft beauty glow", "hqdn3d=2:1:2:1,boxblur=luma_radius=1:luma_power=1,eq=brightness=0.05:saturation=1.12", isPro = true),
        PremiumFeature("ai_eye_enhance", "Smart Eye Enhance", "👁️", "Smart Features", "Sharpen facial details", "unsharp=5:5:0.8:3:3:0.4,eq=contrast=1.05", isPro = true),
        PremiumFeature("ai_makeup", "Smart Makeup", "💋", "Smart Features", "Warm beauty grade", "eq=saturation=1.2:contrast=1.05,colorbalance=rs=0.05:rm=0.03", isPro = true),
        PremiumFeature("ai_deinterlace", "AI Deinterlace", "🖥️", "Smart Features", "Remove interlacing artifacts", "yadif=mode=1", alreadyImplemented = true),
        PremiumFeature("ai_stabilize", "Smart Stabilize", "📐", "Smart Features", "Shake-free stabilization", "deshake,unsharp=5:5:0.5", alreadyImplemented = true),
        PremiumFeature("ai_hdr", "Smart HDR", "🌈", "Smart Features", "HDR-style contrast grade", "eq=contrast=1.25:saturation=1.35,colorbalance=rs=0.06:rm=0.04:bs=0.06:bm=0.04", isPro = true),
        PremiumFeature("ai_cinematic", "Smart Cinematic", "🎬", "Smart Features", "Cinematic teal-orange grade", "colorbalance=rs=0.08:rm=0.05:bs=0.1:bm=0.06,eq=contrast=1.15:saturation=1.05", isPro = true),
        PremiumFeature("ai_audio_enhance", "Smart Audio Enhance", "🔊", "Smart Features", "Clean up and balance audio", "", "afftdn=nr=12:nf=-30,acompressor=threshold=-20dB:ratio=3", isPro = true),
        PremiumFeature("ai_music_match", "Smart Music Match", "🎵", "Smart Features", "Tighten the music mix", "", "bass=g=6:f=100:w=0.5,treble=g=4:f=6000:w=0.6", isPro = true),
        PremiumFeature("ai_magic_edit", "Smart Magic Edit", "🪄", "Smart Features", "One-tap cinematic enhancement", "unsharp=5:5:0.6:3:3:0.3,eq=contrast=1.1:saturation=1.15,colorbalance=rs=0.04:rm=0.03", isPro = true)
    )
    ...
    val audio: List<PremiumFeature> = listOf(
        ...
        PremiumFeature("au_vocal_isolation", "Vocal Isolation", "🎤", "Audio", "Isolate vocals from mix", "", "stereotools=mlev=1:delay=1", isPro = true),
    ...
    val effects: List<PremiumFeature> = listOf(
        ...
        PremiumFeature("fx_sketch", "Sketch", "✏️", "Effects", "Pencil sketch", "format=gray,edgedetect=low=0.1:high=0.4", alreadyImplemented = true),
        ...
        PremiumFeature("fx_distortion", "Distortion", "🌀", "Effects", "Lens distortion warp", "lenscorrection=k1=0.3:k2=0.2", alreadyImplemented = true),
    ...
    val transitions: List<PremiumFeature> = listOf(
        ...
        PremiumFeature("tr_zoom", "Zoom", "🔍", "Transitions", "Zoom in/out transition", "zoompan=z='1+0.5*it':d=1:s=1920x1080:fps=30", alreadyImplemented = true),
        ...
        PremiumFeature("tr_blur", "Blur", "🌫️", "Transitions", "Blur transition", "boxblur=luma_radius=20:luma_power=1", alreadyImplemented = true),
        PremiumFeature("tr_warp", "Warp", "🚀", "Transitions", "Warp speed transition", "zoompan=z='1+2*it':d=1:s=1920x1080:fps=30", isPro = true),
        PremiumFeature("tr_stretch", "Stretch", "↔️", "Transitions", "Elastic stretch transition", "scale=w='trunc(iw*(1+0.5*sin(t*PI))/16)*16':h=ih:eval=frame,crop=w=1920:h=1080", isPro = true),
        PremiumFeature("tr_glitch", "Glitch", "📺", "Transitions", "Glitch transition", "rgbashift=rh=-5:bv=5", alreadyImplemented = true),
        PremiumFeature("tr_flash", "Flash", "⚡", "Transitions", "Flash white transition", "eq=brightness='5*t*(1-t)*4'", alreadyImplemented = true),
        PremiumFeature("tr_ripple", "Ripple", "🌊", "Transitions", "Ripple wave transition", "lenscorrection=k1=0.2:k2=0.2", alreadyImplemented = true),
        PremiumFeature("tr_page_turn", "Page Turn", "📄", "Transitions", "Page flip transition", "perspective=0,hflip", isPro = true),
        PremiumFeature("tr_camera_move", "Camera Move", "🎥", "Transitions", "Simulated camera move", "zoompan=z='1+0.2*it':x='iw*it':y='ih*it':d=1:s=1920x1080:fps=30", isPro = true),
        PremiumFeature("tr_whip_pan", "Whip Pan", "💨", "Transitions", "Fast whip pan transition", "crop=iw:ih:'iw*3*t-2*iw':0", isPro = true),
        PremiumFeature("tr_cube", "Cube", "🧊", "Transitions", "3D cube rotate transition", "rotate='PI*t':fillcolor=black,scale=w='trunc(iw*(1-abs(t-0.5)*0.5)/16)*16':h=ih:eval=frame,pad=w=1920:h=1080:x='trunc((ow-iw)/4)*2':y=0:color=black", isPro = true),
    ...
    val proFeatures: List<PremiumFeature> = listOf(
        ...
        PremiumFeature("pro_hdr", "HDR Export", "🌈", "Pro Features", "10-bit HDR PQ export", "zscale=tin=bt709:min=709:pin=709:rin=tv:t=smpte2084:m=2020_ncl:p=2020:r=tv:npl=100,format=yuv420p10le", isPro = true),
        ...
        PremiumFeature("pro_ai_tools", "Premium Smart Tools", "🤖", "Pro Features", "Advanced smart tools suite", isPro = true),
    ...
    val categories: List<Triple<String, String, String>> = listOf(
        ...
        Triple("aiFeatures", "🤖 Smart Features", "ai"),
