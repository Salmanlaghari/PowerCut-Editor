...
object PremiumFeatureCatalog {
    ...
    val aiFeatures: List<PremiumFeature> = listOf(
        ...
        PremiumFeature("ai_color_correct", "AI Color Correction", "🎨", "AI Features", "Automatic color correction", "eq=contrast=1.1:saturation=1.15:brightness=0.02,curves=preset=increase_contrast", alreadyImplemented = true),
        ...
        PremiumFeature("ai_deblur", "AI Deblur", "🌫️", "AI Features", "Sharpen blurred footage", "unsharp=7:7:1.5:7:7:0.0,smartblur=lr=1:lt=-5", isPro = true),
    ...
    val colorGrading: List<PremiumFeature> = listOf(
        ...
        PremiumFeature("cg_curves", "Curves", "📈", "Color Grading", "RGB curves adjustment", "curves=preset=increase_contrast", alreadyImplemented = true),
    ...
    val effects: List<PremiumFeature> = listOf(
        ...
        PremiumFeature("fx_bokeh", "Bokeh", "🫧", "Effects", "Bokeh blur background", "boxblur=20:2,smartblur", alreadyImplemented = true),
    ...
    val proFeatures: List<PremiumFeature> = listOf(
        ...
        PremiumFeature("pro_color_grading", "Pro Color Grading", "🎨", "Pro Features", "Full pro color grading suite", "colorbalance=rs=0.1:gs=-0.05:bs=0.05,curves=preset=increase_contrast,eq=contrast=1.1:saturation=1.15", isPro = true),
